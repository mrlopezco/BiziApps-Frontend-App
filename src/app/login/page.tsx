...
import { LinkedInLoginButton } from "@/components/authentication/linkedin-login-button"
  ...
  return (
    <div>
      ...
      <div className={"flex flex-col"}>
        ...
        <div
          className={
            "mx-auto w-[343px] md:w-[488px] bg-background/80 backdrop-blur-[6px] px-6 md:px-16 pt-0 py-0 gap-4 flex flex-col items-center justify-center"
          }
        >
          <LinkedInLoginButton label={"Log in with LinkedIn"} />
        </div>
        <div
          className={
